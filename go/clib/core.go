...
//
// libtabnasmarkdown is the markdown format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/markdown/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasmarkdown"
	formatName      = "markdown"
	valueOut        = true
)
...
// newParser builds one engine with the markdown grammar installed
...
// parseWith answers whether src is in the markdown language — and,
